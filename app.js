...
// connect to the DB
let url = process.env.DATABASEURL || "mongodb://localhost/yelp_camp_v13mongodb+srv://momo:<password>@cluster0.h9qyz.mongodb.net/<dbname>?retryWrites=true&w=majority"; // fallback in case global var not working
